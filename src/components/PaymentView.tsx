    ...
    <div className="relative w-full max-w-4xl mx-auto bg-slate-950/60 border border-slate-900 rounded-3xl p-6 sm:p-8 backdrop-blur-xl shadow-2xl overflow-hidden mt-4">
      ...
      {loading && (
        <div className="py-10 flex flex-col items-center justify-center gap-2">
          ...
          <span className="text-xs text-slate-500">Processing collection...</span>
        </div>
      )}
          ...
          <div className="flex gap-2">
            ...
            {!locked && (
              <button
                ...
                className="px-4 py-2 bg-slate-900 hover:bg-slate-800 border border-slate-850 rounded-xl text-xs font-bold text-slate-200 transition-all active:scale-95"
              >
                Search
              </button>
            )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-slate-900/20 border border-slate-900 p-4 rounded-2xl flex flex-col justify-center">
          ...
          <span className="text-sm font-bold text-slate-300 capitalize mt-1">
            {courseName ? courseName.replace("_", " ") : "Not selected"}
          </span>
        </div>
        <div className="bg-slate-900/20 border border-slate-900 p-4 rounded-2xl flex flex-col justify-center">
            ...
            >
              <div className="flex items-center gap-2.5 mb-2">
                <input
                  ...
                  disabled={locked}
                  className="h-4.5 w-4.5 text-teal-500 border-slate-800 bg-slate-950 focus:ring-teal-500/20 focus:ring-offset-slate-950"
                />
              ...
              <div className="mt-4 pt-3 border-t border-slate-900 space-y-2 text-xs">
                ...
                <div className="flex justify-between items-center text-slate-400">
                  ...
                  <select
                    ...
                    disabled={locked}
                    className="bg-slate-950 border border-slate-850 rounded-lg px-2 py-1 text-slate-200 text-xs font-semibold focus:outline-none"
                  >
      ...
      <div className="mt-6 space-y-2">
        ...
        <select
          ...
          disabled={locked}
          className="w-full max-w-xs bg-slate-950 border border-slate-800 rounded-xl px-4 py-2.5 text-sm text-slate-300 focus:outline-none focus:border-teal-500/50 transition-colors"
          required
        >
        ...
        <div className="mt-6 p-4 bg-teal-500/5 border border-teal-500/10 rounded-2xl">
          <label className="flex items-center gap-3 cursor-pointer">
            <input
              ...
              className="h-5 w-5 text-teal-500 border-slate-800 bg-slate-950 rounded focus:ring-teal-500/30 focus:ring-offset-slate-950"
            />
            <span className="text-xs font-semibold text-slate-300">
              I confirm my payment option selection and agree to proceed with the payment plan.
            </span>
          </label>
          <p className="mt-1 text-[10px] text-slate-500 ml-8">
                  ...
                  <tr key={inst.installmentNumber} className="hover:bg-slate-900/20">
                    ...
                    <td className="px-5 py-3 text-center">
                      <input
                        ...
                        className="h-4.5 w-4.5 text-teal-500 border-slate-800 bg-slate-950 rounded focus:ring-teal-500/30"
                      />
                    </td>
                    <td className="px-5 py-3 text-center">
                      {inst.status === "Paid" ? (
                        <button
                          ...
                          className="px-2 py-1 text-[10px] font-bold text-slate-950 bg-emerald-400 hover:bg-emerald-300 transition-colors rounded-lg flex items-center justify-center gap-1 mx-auto shadow shadow-emerald-500/10"
                        >
      ...
      <div className="border-t border-slate-900 pt-6 mt-8 flex justify-between items-center">
        ...
        {confirmed && (
          <button
            ...
            className="px-6 py-2.5 text-xs font-bold text-slate-950 bg-gradient-to-r from-teal-400 to-indigo-400 hover:opacity-90 transition-all rounded-xl shadow-lg shadow-teal-500/10"
          >
        ...
        <div className="fixed inset-0 z-55 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md">
          <div className="bg-white text-slate-900 rounded-3xl p-6 sm:p-8 max-w-lg w-full border border-slate-200 shadow-2xl relative">
            <button 
              ...
              className="no-print absolute top-4 right-4 w-8 h-8 rounded-full bg-slate-100 hover:bg-rose-500/10 text-slate-600 hover:text-rose-600 transition-colors flex items-center justify-center"
            >
            ...
            <div id="receipt-print-area" className="p-4 border-2 border-slate-900 rounded-2xl space-y-4">
              <div className="text-center pb-2 border-b border-slate-300">
                ...
                <p className="text-[9px] text-slate-500 uppercase tracking-widest">{printReceiptData.branch} Branch</p>
              </div>
              ...
              <div className="pt-4 flex justify-between items-end text-[9px] text-slate-500">
                <div>
                  ...
                  <p className="mt-1">{printReceiptData.receivedBy}</p>
                </div>
